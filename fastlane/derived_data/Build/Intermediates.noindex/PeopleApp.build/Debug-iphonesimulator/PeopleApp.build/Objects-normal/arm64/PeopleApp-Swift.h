...
#ifndef PEOPLEAPP_SWIFT_H
#define PEOPLEAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PeopleApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9PeopleApp11AppDelegate")
...
SWIFT_CLASS("_TtC9PeopleApp22MockURLSessionProtocol")
@interface MockURLSessionProtocol : NSURLProtocol
